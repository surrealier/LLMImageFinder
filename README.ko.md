# LLMImageFinder — 데이터셋 자연어 이미지 검색 (sLLM_)

> 🇬🇧 English overview: [README.md](README.md) · 📐 설계 철학: [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md)
> 이 문서는 한국어 상세 사용 설명서입니다.
...
[uv](https://docs.astral.sh/uv/)가 필요합니다. Python 3.12는 uv가 자동 설치합니다.

```powershell
# 의존성 설치 (PySide6, chromadb, pillow, numpy, httpx, rank-bm25 등)
uv sync
...
uv run python scripts/make_screenshots.py  # README 스크린샷 재생성
```
...
scripts/     smoke · ui_smoke · build_index · set_class_names · check_vllm · make_screenshots · …
```
